...
\renewcommand{\title}{%
  {\LARGE Técnicas Avançadas de Programação Multimídia Multiplataforma para Videogames}\\[4pt]
  \mbox{Superando as diferenças da Web, Java, e sistemas operacionais móveis}%
