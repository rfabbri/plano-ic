...
\begin{figure}
    ...
    densificada~\cite{Bundler,VisualSFM,Furukawa:Ponce:CVPR2007,Goesele}, ou
    atribuída de
...
multi-perspectiva/multi-ocular, como os do grupo de Michel Goesele~\cite{Goesele},
...
VisualSFM~\cite{}, Visao estereo densa de Michel Goesele~\cite{}, e o sistema de
...
Fusion~\cite{} \todo{Pedro: inserir outros que ja explorour}. Por se
...
\item \textbf{Escrita e Uso de Software Livre.} Uso e a programação de software
  de reconstrução 3D, em especial VisualSFM~\cite{}, Visao estereo densa de
  Michel Goesele~\cite{}, e o sistema de reconstrução 3D do prof.\ proponente
