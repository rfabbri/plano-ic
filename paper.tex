...
de nível Adjunto IV no Instituto Politécnico -- IPRJ da UERJ. Pretende-se
trabalhar em conjunto com o grupo de pesquisa do Prof. Francisco Moura Neto, do Departamento de
Modelagem Computacional, com atividade principal de pesquisa descrita na próxima
seção.  Ademais, pretende-se colaborar com outros pesquisadores na
realização de projetos e publicação de artigos, tanto no IPRJ como com pesquisadores das
instituições de origem do pesquisador proponente: o ICMC (Instituto de Ciências
Matemáticas e de Computação) e o IFSC (Instituto de Física) da USP de São
Carlos, bem como a Brown University.  
