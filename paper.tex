...
\renewcommand{\date}{\textsf{IPRJ--UERJ}\\\textsf{Agosto de 2011}}
\newcommand{\info}{%
%  \raisebox{4pt}[-4pt]{%
...
O presente plano de pesquisa se refere a atividades propostas para a bolsa de
produtividade em pesquisa do CNPq, a serem realizadas como professor 
de nível Adjunto IV no Instituto Politécnico -- IPRJ da UERJ, Departamento de
Modelagem Computacional. Pretende-se trabalhar em conjunto com o grupo de
pesquisa do Prof. Francisco Moura Neto e com outros pesquisadores na
realização de projetos e publicação de artigos, tanto no IPRJ como no ICMC
(Instituto de Ciências Matemáticas e de Computação) e no IFSC (Instituto de
Física) da USP de São Carlos, bem como a Brown University (EUA), a Universidade
de Liverpool (Reino Unido), e a UFRJ.
...
execução deste projeto, o período foi dividido em etapas anuais.
\begin{center}
...
\hline
Teoria de Geometria Diferencial Projetiva de Superfícies &  & X &  \\
\hline
Sistema 3D Curve Sketch &   & X & X \\
\hline
Estudo de Geometria Algébrica & X & X & \\
\hline
Experimentos de Larga escala &   &   & X\\
\hline
