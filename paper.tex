...
diferencial local) em um sistema de coordenadas global e na imagem.
...
A tabela abaixo mostra o cronograma para as atividades descritas. Para a
...
\hline
Palestras nos cursos do IPRJ & X & X & X & X\\
\hline
Outras Colaborações no IPRJ  & X & X & X & X  \\
\hline
\end{tabular}
\end{center}
