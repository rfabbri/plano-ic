...
\begin{figure}[H]
\centering
\subfigure[]{\label{fig:davida}\includegraphics[width=0.18\linewidth]{figs/Proto+Inka+Egypt_light-s.jpg}}
% \vspace{2ex}
\subfigure[]{\label{fig:davidb}\includegraphics[width=0.18\linewidth]{figs/gantry-with-david-s.jpg}}
\subfigure[]{\label{fig:davidc}\includegraphics[width=0.18\linewidth]{figs/scanner-head-and-david-head-s.jpg}}
% \vspace{2ex}
\subfigure[]{\label{fig:davidd}\includegraphics[width=0.18\linewidth]{figs/david-classic-leftlight-s.jpg}}
\caption{%
...
% 	\centering
% 	%   \includegraphics[width=1.0\linewidth]{figs/3d-curve-sketch/system-diagram.eps}
% 	\includegraphics[width=0.3\linewidth]{figs/Proto+Inka+Egypt_light-s.jpg}(a)
% 	\vspace{4ex}
% 	\includegraphics[width=0.25\linewidth]{figs/gantry-with-david-s.jpg}(b)
%   \includegraphics[width=0.3\linewidth]{figs/scanner-head-and-david-head-s.jpg}(c)
%   \vspace{4ex}
%   \includegraphics[width=0.25\linewidth]{figs/david-classic-leftlight-s.jpg} (d)
% 	\caption{%
%     Protótipo do scanner a laser de triangulação. O objeto a ser escaneado é uma réplica em tamanho real
%     de um sarcófago egípcio (a). O scanner teve que ser reconfigurado para escanear objetos maiores, pois 
%     a escultura possui 517 centímetros (b), o da cabeça também sofreu uma reconfiguração, este scanner gira em 90 graus, 
%     que faz o laser rotacionar, da posição horizontal para a vertical e também roda em torno da cabeça como um todo (c).
%     Para a reconstrucão, o primeiro passo foi alinhar cerca de 100 scans em diversas posicoes, após isso, utilizado um 
%     alinhamento automatico em pares dos scans, utilizando um algoritmo modificado de iteracoes de pontos próximos 
%     (ICP - {\it iterated-closets-points}). Após isso, faz-se um processo de relaxação global a fim de minimizar erros 
%     de alinhamento por toda a estátua. Depois de alinhados, usa-se o algoritmo de profundidade volumétrica de 
%     processamento de imagens (VRIP - {\it volumetric range image processing} - do Brian Curless) (d).
% 	}\label{fig:david}
% \end{figure}
...
VisualSFM~\cite{Changchang:VisualSFM}, Visão estereo densa de Michel Goesele~\cite{Goesele:MVE:2014}, o sistema de
reconstrução 3D do prof.\ proponente deste projeto~\cite{Usumezbas:Fabbri:Kimia:ECCV16,Fabbri:Kimia:IJCV2016,Fabbri:Kimia:CVPR10,Fabbri:Giblin:Kimia:ECCV12}, Kinnect
Fusion~\cite{KinectFusion}, e técnicas por Luz Estruturada~\cite{Taubin:StructuredLight}. Por se
...
\item \textbf{Escrita e Uso de Software Livre.} Uso e a programação de software
  ...
  deste projeto~\cite{Usumezbas:Fabbri:Kimia:ECCV16,Fabbri:Kimia:IJCV2016,Fabbri:Kimia:CVPR10,Fabbri:Giblin:Kimia:ECCV12}, 
  e Kinnect Fusion~\cite{KinectFusion} 
