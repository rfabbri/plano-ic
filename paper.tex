...
\begin{figure}
	...
	\caption{%
    Kinnect de primeira geração (câmeras e projetores infra-vermelho) e de
    segunda geração (ToF). Ambos os kinnects são largamente utilizados para
    escaneamento em tempo real, como base de scanners manuais, porém nem sempre
    são úteis para preservação detalhada de patrimônio. Um dos objetivos deste
    projeto é determinar os limites desta tecnologia.
	}\label{fig:kinect}
\end{figure}
...
reconstrução 3D do prof.\ proponente deste projeto~\cite{Fabbri:ECCV16}, e Kinnect
...
\item \textbf{Escrita e Uso de Software Livre.} Uso e a programação de software
  ...
  deste projeto~\cite{Fabbri:ECCV16}, e Kinnect Fusion~\cite{} 
